...
.PHONY: all build clean gensamples genimages genvideo genhistory genbook genwords genunderground genbase setup_tools setup_zig setup_ffmpeg setup_python
